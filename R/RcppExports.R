...
#' @export
logit_irwls_fit <- function(X, y, max_it = 25L, tol = 1e-08) {
    .Call(`_snpcombineR_logit_irwls_fit`, X, y, max_it, tol)
}
...
#' @export
simulate_gene_level_stats <- function(init_genotype_data, resample, n_resamples, is_non_null, causal_snp_i, causal_or, case_rate, sim_n_blocks, sim_block_size, n_cores, eps) {
...
#' @export
resample_gene_test_sim <- function(genotype_data, n_resamples, n_gene_sims, is_non_null, causal_snp_i, causal_or, case_rate, truth_sim_n_blocks, truth_sim_block_size, n_cores, eps) {
...
#' @export
sim_gene_cor_gwas_gene <- function(genotype_data, genotype_cor_matrix, sim_truth_matrix, n_gene_sims, is_non_null, causal_snp_i, causal_or, case_rate, n_cores) {
    .Call(`_snpcombineR_sim_gene_cor_gwas_gene`, genotype_data, genotype_cor_matrix, sim_truth_matrix, n_gene_sims, is_non_null, causal_snp_i, causal_or, case_rate, n_cores)
}
